...
export const PRODUCTS = [
  ...
  { code: "PI002", category: "Postres Individuales", name: "Tiramisú Clásico", price: 5500, type: "otro", img: "/img/products/tiramisu_clasico.png", description: "Capas de café, mascarpone y cacao.", ingredients: ["Bizcochos", "Café", "Mascarpone", "Azúcar", "Cacao"] },
  { code: "PSA001", category: "Productos Sin Azúcar", name: "Torta Sin Azúcar de Naranja", price: 48000, type: "otro", img: "/img/products/torta_sin_azucar_naranja.png", description: "Endulzada naturalmente.", ingredients: ["Harina", "Endulzante", "Huevos", "Naranja", "Aceite"], tags: ["sin_azucar"] },
  ...
  { code: "PV002", category: "Productos Veganos", name: "Galletas Veganas de Avena", price: 4500, type: "otro", img: "/img/products/galletas_veganas_avena.png", description: "Galletas veganas de avena.", ingredients: ["Avena","Azúcar","Aceite vegetal","Esencia de vainilla"], tags: ["vegano"] },
